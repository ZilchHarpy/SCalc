"""
Testes unitarios para modulo de parsers
"""
...
class TestParsers(unittest.TestCase):
    """Testes para funcoes de parsing"""
    
    def test_extrair_prefixo_simples(self):
        """Testa extracao de prefixo simples"""
    ...
    def test_extrair_prefixo_complexo(self):
        """Testa extracao com nomes mais complexos"""
    ...
    def test_eh_erro_instrumental_valido(self):
        """Testa deteccao de colunas de erro"""
    ...
    def test_eh_erro_instrumental_invalido(self):
        """Testa casos que nao sao erro instrumental"""
